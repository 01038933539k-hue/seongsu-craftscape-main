        ...
        <div className="bg-card border border-rule/50 rounded-2xl p-8 shadow-sm">
          ...
          <ul className="space-y-8">
            ...
            <li className="flex gap-4">
              ...
              <p className="text-ink leading-relaxed text-lg">
                제조업 밀집 지역은 기존 전통 제조업의 입지와 다르게 <strong className="text-primary 시font-bold">지식산업센터에도 제조업이 위치</strong>한다.
              </p>
            </li>
          </ul>
        </div>
      </FadeIn>
      <PageNavigation prev={{ to: "/east-west", label: "02 동서비교" }} next={{ to: "/floors", label: "04 층/건물 분석" }} />
    </>
  );
}
