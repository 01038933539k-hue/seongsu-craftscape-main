  ...
  return (
    <>
      ...
      <section className="container-prose py-16 md:py-24 rule-top">
        ...
        {/* INJECTED USER IMAGE */}
        <div className="mb-16 bg-white p-4 md:p-8 rounded-2xl border border-rule/50 shadow-sm overflow-hidden flex justify-center">
          <img 
...
`;
fs.writeFileSync('src/routes/timeline.tsx', content, 'utf-8');
console.log('Restored clean timeline.tsx and successfully added the image.');
